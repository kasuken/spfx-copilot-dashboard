...
export const CopilotIcon = () => {
  return (
  <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="16" height="16" viewBox="0 0 48 48" style={{ verticalAlign: "middle", marginRight: "5px"}}>
    <linearGradient id="lfK0TEarAX_CVWY9eruXya_PxQoyT1s0uFh_gr1" x1="18.179" x2="37.232" y1="6.205" y2="21.237" gradientUnits="userSpaceOnUse">
    ...
    <path fill="url(#lfK0TEarAX_CVWY9eruXya_PxQoyT1s0uFh_gr1)" d="M21.676,19.303c0,0,0.814-3.255,4.691-3.399h11.777c0,0-3.399-0.287-4.069-4.404	c-0.67-4.117-2.441-5.745-4.931-5.793c-2.489-0.048-3.638,2.585-3.926,3.495C24.931,10.112,21.676,19.303,21.676,19.303z" />
    <linearGradient id="lfK0TEarAX_CVWY9eruXyb_PxQoyT1s0uFh_gr2" x1="8.61" x2="20.866" y1="36.864" y2="1.503" gradientUnits="userSpaceOnUse">
    ...
    <path fill="url(#lfK0TEarAX_CVWY9eruXyb_PxQoyT1s0uFh_gr2)" d="M19.234,29.261l6.032-20.25	c0,0,1.149-3.399,3.878-3.303H14.016c0,0-2.585,0-4.452,2.968c0,0-2.872,3.734-4.548,11.394s-1.005,8.09-1.005,8.09	s-0.431,4.213,6.032,3.878h4.979C15.021,32.037,18.037,32.085,19.234,29.261z" />
    ...
    <linearGradient id="lfK0TEarAX_CVWY9eruXyc_PxQoyT1s0uFh_gr3" x1="9.38" x2="27.188" y1="35.55" y2="35.358" gradientUnits="userSpaceOnUse">
    ...
    <path fill="url(#lfK0TEarAX_CVWY9eruXyc_PxQoyT1s0uFh_gr3)" d="M26.474,28.607	c0,0-0.814,3.255-4.691,3.399H10.006c0,0,3.399,0.287,4.069,4.404s2.441,5.745,4.931,5.793s3.638-2.585,3.926-3.495	C23.219,37.799,26.474,28.607,26.474,28.607z" />
    ...
    <linearGradient id="lfK0TEarAX_CVWY9eruXyd_PxQoyT1s0uFh_gr4" x1="28.874" x2="37.108" y1="43.472" y2="12.068" gradientUnits="userSpaceOnUse">
      <stop offset="0" stop-color="#ffb152" />
      <stop offset=".531" stop-color="#f36284" />
      <stop offset=".994" stop-color="#a355e9" />
    </linearGradient>
    <path fill="url(#lfK0TEarAX_CVWY9eruXyd_PxQoyT1s0uFh_gr4)" d="M28.915,18.65l-6.07,20.263	c0,0-1.111,3.386-3.839,3.29h15.128c0,0,2.585,0,4.452-2.968c0,0,2.872-3.734,4.548-11.394c1.676-7.66,1.005-8.09,1.005-8.09	s0.431-4.213-6.032-3.878h-4.979C33.128,15.873,30.112,15.826,28.915,18.65z" />
  </svg>
  );
}
